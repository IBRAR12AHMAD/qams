...
class ScheduleController extends Controller
{
    ...
    //                     return optional($row->editor)->name ?? '-';
    //                 })
    ...
    //                         $btn .= '<a href="'.route('editschedule', $row->id).'" class="btn btn-sm btn-success me-1">Edit</a>';
    //                     }
    //                     return $btn;
    //                 })
    ...
    //         'aditor_id'=> Auth::user()->employee_id,
    ...
    //     return view('schedule.edit', compact('schedules', 'audits', 'programs', 'campuses',
    //         'checklists', 'aditorusers', 'selectedPrograms', 'selectedDepartments'
    //     ));
    // }
