        ...
        <div class="card mb-5 mb-xl-12">
            <div class="card-header border-0 cursor-pointer" role="button" data-bs-toggle="collapse" data-bs-target="#kt_account_profile_details" aria-expanded="true" aria-controls="kt_account_profile_details">
                <div class="card-title m-0">
                    <h3 class="fw-bold m-0">Create Audit</h3>
                </div>
            </div>
            <div id="kt_account_settings_profile_details" class="collapse show">
                <form id="kt_account_profile_details_form" action="{{route('storeaudit')}}" method="POST">
                    @csrf
                            ...
                            <div class="col-lg-12">
                                <div class="row">
                                    <div class="col-lg-6 fv-row">
                                        ...
                                        placeholder="Enter Audit Title" oninvalid="this.setCustomValidity('Please Enter Audit title')" oninput="this.setCustomValidity('')" required/>
                                    ...
                                    <div class="col-lg-6 fv-row">
                                        <label class="col-lg-4 col-form-label required fw-semibold fs-6">Start Date</label>
                                           <div class="position-relative d-flex align-items-center">
                                                ...
                                                <input name="start_date" class="form-control form-control-sm mb-3 mb-lg-0 ps-12 @error('start_date') is-invalid @enderror" name="date" placeholder="Pick a start date" id="kt_datepicker_1" value="{{ old('start_date') }}" required/>
                                            </div>
                            ...
                            <div class="col-lg-12">
                                <div class="row">
                                    <div class="col-lg-6 fv-row">
                                        ...
                                        <select name="status" data-control="select2" class="form-select form-select-sm fw-semibold mb-3 mb-lg-0 @error('status') is-invalid @enderror" value="{{ old('status') }}">
