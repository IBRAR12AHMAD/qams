                            ...
                            <tr>
                                ...
                                <td>
                                    @if ($edit_permission == 'true' || $check_all_permission == 'true')
                                        <a href="{{ route('editaudit', $audit->id) }}" class="btn btn-sm btn-success">Edit</a>
                                    @endif
                                </td>
                            </tr>
                        @endforeach --}}
...
<script>
    $(function () {
        ...
        var table = $('#kt_ecommerce_report_views_table').DataTable({
            ...
            buttons: [
                { extend: 'copyHtml5', title: 'Audits', className: 'd-none' },
                { extend: 'excelHtml5', title: 'Audits', className: 'd-none' },
                { extend: 'csvHtml5', title: 'Audits', className: 'd-none' },
                { extend: 'pdfHtml5', title: 'Audits', className: 'd-none' }
            ]
        });
