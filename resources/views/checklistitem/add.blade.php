                            ...
                            <table class="table table-row-dashed">
                                <thead class="table-light">
                                    <tr>
                                        ...
                                        {{-- <th style="width: 15%;" class="required">Order No</th> --}}
                                ...
                                <tbody id="dynamicRows">
                                    ...
                                    @foreach($parameters as $i => $param)
                                        <tr class="rowItem">
                                            ...
                                            {{-- <td>
                                                <input type="number" class="form-control form-control-sm" name="order_number[]" placeholder="Enter Order Number" value="{{ old('order_number')[$i] ?? '' }}"/>
    ...
    $(document).ready(function () {
        ...
        $(document).on("click", ".addRow", function () {
            ...
            <tr class="rowItem">
                ...
                <td>
                    <input type="text" class="form-control form-control-sm" name="parameter[]" placeholder="Enter Input"
                        oninvalid="this.setCustomValidity('Please Enter Input')" oninput="this.setCustomValidity('')" required/>
                </td>
                <td>
                    <select name="header_id[]" class="form-select form-select-sm" data-control="select2">
