    ...
    <div id="kt_app_content_container" class="app-container container-xxl ">
        <div class="card mb-5 mb-xl-12">
            ...
            <div id="kt_account_settings_profile_details" class="collapse show">
                <form id="kt_account_profile_details_form" action="{{ route('storerole') }}" method="POST">
                    @csrf
                            ...
                            <div class="col-lg-12">
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 fv-row">
                                        ...
                                        <input type="text" name="slug" class="form-control form-control-sm mb-3 mb-lg-0" id="permalink" value="{{ old('slug') }}" readonly/>
