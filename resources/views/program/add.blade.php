        ...
        <div class="card mb-5 mb-xl-12">
            <div class="card-header border-0 cursor-pointer" role="button" data-bs-toggle="collapse" data-bs-target="#kt_account_profile_details" aria-expanded="true" aria-controls="kt_account_profile_details">
                <div class="card-title m-0">
                    <h3 class="fw-bold m-0">Create Program</h3>
                </div>
            </div>
            <div id="kt_account_settings_profile_details" class="collapse show">
                <form id="kt_account_profile_details_form" action="{{route('storeprogram')}}" method="POST">
                    @csrf
                            ...
                            <div class="col-lg-12">
                                <div class="row">
                                    <div class="col-lg-6 fv-row">
                                        ...
                                        <input id="program_name" type="text" class="form-control form-control-sm mb-3 mb-lg-0" name="program_name" value="{{ old('program_name') }}"
                                        placeholder="Enter Program Name" oninvalid="this.setCustomValidity('Please Enter Program Name')" oninput="this.setCustomValidity('')" required/>
                                    ...
                                    <div class="col-lg-6 fv-row">
                                        ...
                                        <select name="department_id" data-control="select2" class="form-select form-select-sm fw-semibold @error('department_id') is-invalid @enderror">
                                            <option selected disabled>- Select Department -</option>
                                            @foreach ($departments as $department)
                                                <option value="{{ $department->id }}"
                                                    {{ old('department_id', $programs->department_id ?? '') == $department->id ? 'selected' : '' }}>
