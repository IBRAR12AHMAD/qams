        ...
        <div class="card mb-5 mb-xl-12">
            <div class="card-header border-0 cursor-pointer" role="button" data-bs-toggle="collapse" data-bs-target="#kt_account_profile_details" aria-expanded="true" aria-controls="kt_account_profile_details">
                <div class="card-title m-0">
                    <h3 class="fw-bold m-0">Create Module</h3>
                </div>
            </div>
            <div id="kt_account_settings_profile_details" class="collapse show">
                <form id="kt_account_profile_details_form" action="{{ route('storemodule') }}" method="POST">
                    @csrf
                            ...
                            <div class="col-lg-12">
                                <div class="row">
                                    <div class="col-lg-6 fv-row">
                                        ...
                                        <input id="module_name" type="text" onblur="menus('{{url('/')}}')" class="form-control form-control-sm mb-3 mb-lg-0" name="module_name" value="{{ old('module_name') }}"
                                    ...
                                    <div class="col-lg-6 fv-row">
                                        ...
                                        <input type="text" name="icon" class="form-control form-control-sm mb-3 mb-lg-0 @error('icon') is-invalid @enderror" placeholder="Enter Icon" value="{{ old('icon') }}" />
                            ...
                            <div class="col-lg-12">
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 fv-row">
                                        ...
                                        <input type="text" id="permalink" name="slug" class="form-control form-control-sm mb-3 mb-lg-0 @error('slug') is-invalid @enderror" {{ old('slug') }} />
                            ...
                            <div class="col-lg-12">
                                <div class="row">
                                    <div class="col-lg-6 fv-row">
                                        ...
                                        <select name="category_id" data-control="select2" class="form-select form-select-sm fw-semibold mb-3 mb-lg-0 @error('category_id') is-invalid @enderror" value="{{ old('category_id') }}">
                                    ...
                                    <div class="col-lg-6 fv-row">
                                        ...
                                        <textarea type="text" id="menudescription" name="menu_template" class="form-control form-control-sm mb-3 mb-lg-0 @error('menu_template') is-invalid @enderror">{{ old('menu_template') }}</textarea>
                            ...
                            <div class="col-lg-12">
                                <div class="row">
                                    <div class="col-lg-6 fv-row">
                                        ...
                                        <input type="text" id="order_via" name="order_via" class="form-control form-control-sm mb-3 mb-lg-0  @error('order_via') is-invalid @enderror" {{ old('order_via') }} />
