    ...
    <div id="kt_app_content_container" class="app-container container-xxl ">
        ...
        <div class="card card-flush">
            <div class="card-header align-items-center py-5 gap-1 gap-md-5">
                ...
                <a type="button" class="btn btn-sm btn-light-primary" href="{{ route('adduser') }}">
...
<script>
    $(function () {
        ...
        var table = $('#kt_ecommerce_report_views_table').DataTable({
            ...
            buttons: [
                { extend: 'copyHtml5', title: 'Users', className: 'd-none' },
                { extend: 'excelHtml5', title: 'Users', className: 'd-none' },
                { extend: 'csvHtml5', title: 'Users', className: 'd-none' },
                { extend: 'pdfHtml5', title: 'Users', className: 'd-none' }
            ]
        });
